...
public:
	...
	HRESULT Render_Outline(class CShader*& pShader, _bool bToon = true);
	HRESULT Render_Inline(class CShader*& pShader);

	HRESULT Render_SingleMesh(class CShader*& pShader, const _int& iMeshIndex);
	HRESULT Render_ToonMesh(class CShader*& pShader, const _int& iMeshIndex);
	...
	HRESULT Render_GrassInstance(ID3D11Buffer* pInstanceBuffer, _uint iSize, class CShader*& pShader, _uint iStride);
	...
	HRESULT Render_SingleMeshGrassInstance(ID3D11Buffer* pInstanceBuffer, _uint iSize, class CShader*& pShader, const _int& iMeshIndex, _uint iStride);
