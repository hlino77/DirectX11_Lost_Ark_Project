...
private:
	_bool	Is_Hit()
	{
		if (static_cast<CMonster_Server*>(m_pGameObject)->Get_Hp() < 1 || static_cast<CMonster_Server*>(m_pGameObject)->Is_Bound() || static_cast<CMonster_Server*>(m_pGameObject)->Is_Twist() || static_cast<CMonster_Server*>(m_pGameObject)->Is_Hit() || static_cast<CMonster_Server*>(m_pGameObject)->Is_SecondHit())
			return true;
