...
CValtan_BT_Attack_TrippleCounterChop_3_Server::CValtan_BT_Attack_TrippleCounterChop_3_Server()
{
}

void CValtan_BT_Attack_TrippleCounterChop_3_Server::OnStart()
{
	__super::OnStart(0);
...
CBT_Node::BT_RETURN CValtan_BT_Attack_TrippleCounterChop_3_Server::OnUpdate(const _float& fTimeDelta)
{
...
void CValtan_BT_Attack_TrippleCounterChop_3_Server::OnEnd()
{
	__super::OnEnd();
...
void CValtan_BT_Attack_TrippleCounterChop_3_Server::On_LastAnimEnd()
{
...
CValtan_BT_Attack_TrippleCounterChop_3_Server* CValtan_BT_Attack_TrippleCounterChop_3_Server::Create(void* pArg)
{
	CValtan_BT_Attack_TrippleCounterChop_3_Server* pInstance = new CValtan_BT_Attack_TrippleCounterChop_3_Server;
...
void CValtan_BT_Attack_TrippleCounterChop_3_Server::Free()
{
	__super::Free();
}
