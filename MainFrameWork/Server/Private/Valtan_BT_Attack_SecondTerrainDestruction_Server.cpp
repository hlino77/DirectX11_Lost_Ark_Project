...
CValtan_BT_Attack_SecondTerrainDestruction_Server::CValtan_BT_Attack_SecondTerrainDestruction_Server()
{
}

void CValtan_BT_Attack_SecondTerrainDestruction_Server::OnStart()
{
	__super::OnStart(0);
...
CBT_Node::BT_RETURN CValtan_BT_Attack_SecondTerrainDestruction_Server::OnUpdate(const _float& fTimeDelta)
{
...
void CValtan_BT_Attack_SecondTerrainDestruction_Server::On_FirstAnimStart()
{
	static_cast<CBoss_Server*>(m_pGameObject)->Set_GroggyLock(true);
}

void CValtan_BT_Attack_SecondTerrainDestruction_Server::On_LastAnimEnd()
{
...
CValtan_BT_Attack_SecondTerrainDestruction_Server* CValtan_BT_Attack_SecondTerrainDestruction_Server::Create(void* pArg)
{
	CValtan_BT_Attack_SecondTerrainDestruction_Server* pInstance = new CValtan_BT_Attack_SecondTerrainDestruction_Server;
...
void CValtan_BT_Attack_SecondTerrainDestruction_Server::Free()
{
	__super::Free();
}
