...
CValtan_BT_Attack_TrippleCounterChop_2_Server::CValtan_BT_Attack_TrippleCounterChop_2_Server()
{
}

void CValtan_BT_Attack_TrippleCounterChop_2_Server::OnStart()
{
	__super::OnStart(0);
...
CBT_Node::BT_RETURN CValtan_BT_Attack_TrippleCounterChop_2_Server::OnUpdate(const _float& fTimeDelta)
{
...
void CValtan_BT_Attack_TrippleCounterChop_2_Server::OnEnd()
{
	__super::OnEnd();
...
CValtan_BT_Attack_TrippleCounterChop_2_Server* CValtan_BT_Attack_TrippleCounterChop_2_Server::Create(void* pArg)
{
	CValtan_BT_Attack_TrippleCounterChop_2_Server* pInstance = new CValtan_BT_Attack_TrippleCounterChop_2_Server;
...
void CValtan_BT_Attack_TrippleCounterChop_2_Server::Free()
{
	__super::Free();
}
