...
void CValtan_BT_Attack_Attack6_Server::OnStart()
{
	__super::OnStart(0);
...
void CValtan_BT_Attack_Attack6_Server::OnEnd()
{
	__super::OnEnd();
...
CValtan_BT_Attack_Attack6_Server* CValtan_BT_Attack_Attack6_Server::Create(void* pArg)
{
	CValtan_BT_Attack_Attack6_Server* pInstance = new CValtan_BT_Attack_Attack6_Server;
...
void CValtan_BT_Attack_Attack6_Server::Free()
{
	__super::Free();
}
