...
HRESULT CChaosDungean_Server::Ready_ChaosDungean(CHAOSDUNGEANLEVEL eLevel)
{
	...
	case CHAOSDUNGEANLEVEL::LEVEL1:
		...
		m_fStartDelay = 3.f;
		m_iMonsterCount = 0;//500;
		m_iMonsterMaxSpawnCount = 0;//10;
		m_iBossCount = 0;
	...
	case CHAOSDUNGEANLEVEL::LEVEL2:
		...
		m_fStartDelay = 3.f;
		m_iMonsterCount = 0;//100;
		m_iMonsterMaxSpawnCount = 0;//50;
		m_iBossCount = 0;//3;
...
void CChaosDungean_Server::Update_Ratio()
{
	...
	case CHAOSDUNGEANLEVEL::LEVEL1:
		...
		{
			Send_Ratio(1.0f - ((m_iMonsterCount + m_Monsters.size()) / 500.0f));
		}
	...
	case CHAOSDUNGEANLEVEL::LEVEL2:
		...
		{
			Send_Ratio(1.0f - ((m_iBossCount + m_Bosses.size()) / 3.0f));
		}
		break;
	case CHAOSDUNGEANLEVEL::LEVEL3:
		if (m_iBossCount == 0 && m_Bosses.size() == 0)
