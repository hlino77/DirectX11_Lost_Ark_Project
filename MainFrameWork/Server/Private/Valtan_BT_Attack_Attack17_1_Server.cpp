...
CValtan_BT_Attack_Attack17_1_Server::CValtan_BT_Attack_Attack17_1_Server()
{
}

void CValtan_BT_Attack_Attack17_1_Server::OnStart()
{
	__super::OnStart(0);
...
CBT_Node::BT_RETURN CValtan_BT_Attack_Attack17_1_Server::OnUpdate(const _float& fTimeDelta)
{
...
void CValtan_BT_Attack_Attack17_1_Server::OnEnd()
{
	__super::OnEnd();
	static_cast<CMonster_Server*>(m_pGameObject)->Set_Attacked(true);
}

void CValtan_BT_Attack_Attack17_1_Server::On_FirstAnimStart()
{
...
CValtan_BT_Attack_Attack17_1_Server* CValtan_BT_Attack_Attack17_1_Server::Create(void* pArg)
{
	CValtan_BT_Attack_Attack17_1_Server* pInstance = new CValtan_BT_Attack_Attack17_1_Server;
...
void CValtan_BT_Attack_Attack17_1_Server::Free()
{
	__super::Free();
}
