...
CValtan_BT_Attack_Attack8_Server::CValtan_BT_Attack_Attack8_Server()
{
}

void CValtan_BT_Attack_Attack8_Server::OnStart()
{
	__super::OnStart(0);
...
CValtan_BT_Attack_Attack8_Server* CValtan_BT_Attack_Attack8_Server::Create(void* pArg)
{
	CValtan_BT_Attack_Attack8_Server* pInstance = new CValtan_BT_Attack_Attack8_Server;
...
void CValtan_BT_Attack_Attack8_Server::Free()
{
	__super::Free();
}
