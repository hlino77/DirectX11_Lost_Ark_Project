...
technique11 DefaultTechnique
{
    ...
    pass OneBlendXWrapYBorder
    {
		...
		HullShader = NULL;
		DomainShader = NULL;
        PixelShader = compile ps_5_0 PS_MAIN_FXTEX(true, 3);
        ComputeShader = NULL;
    }
    ...
    pass AlphaBlendXWrapYBorder
    {
        ...
        HullShader = NULL;
        DomainShader = NULL;
        PixelShader = compile ps_5_0 PS_MAIN_FXTEX(false, 3);
        ComputeShader = NULL;
    }
    ...
    pass OneBlendXBorderYWrap
    {
		...
		HullShader = NULL;
		DomainShader = NULL;
        PixelShader = compile ps_5_0 PS_MAIN_FXTEX(true, 4);
        ComputeShader = NULL;
    }
    ...
    pass AlphaBlendXBorderYWrap
    {
        ...
        HullShader = NULL;
        DomainShader = NULL;
        PixelShader = compile ps_5_0 PS_MAIN_FXTEX(false, 4);
        ComputeShader = NULL;
    }
}
