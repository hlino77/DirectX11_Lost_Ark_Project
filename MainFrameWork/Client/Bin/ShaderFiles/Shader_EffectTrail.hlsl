...
PS_OUT_EFFECT PS_MAIN_FXTRAIL(VS_OUT_FXTRAIL In, uniform bool bOneBlend)
{
...
technique11 DefaultTechnique
{
    pass OneBlend
    {
        ...
        HullShader = NULL;
        DomainShader = NULL;
        PixelShader = compile ps_5_0 PS_MAIN_FXTRAIL(true);
        ComputeShader = NULL;
    }
    ...
    pass AlphaBlend
    {
        ...
        HullShader = NULL;
        DomainShader = NULL;
        PixelShader = compile ps_5_0 PS_MAIN_FXTRAIL(false);
        ComputeShader = NULL;
    }
}