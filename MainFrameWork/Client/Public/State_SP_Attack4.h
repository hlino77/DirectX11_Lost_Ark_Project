...
class CState_SP_Attack4 final : public CState
{
public:
	CState_SP_Attack4(const wstring& strStateName, class CStateMachine* pMachine, class CPlayer_Controller* pController, class CPlayer_Doaga* pOwner);
	virtual ~CState_SP_Attack4() = default;
