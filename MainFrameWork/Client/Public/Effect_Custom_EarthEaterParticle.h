...
class CEffect_Custom_EarthEaterParticle : public CEffect
{
	using Super = CEffect;
public:
...
private:
	CEffect_Custom_EarthEaterParticle(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CEffect_Custom_EarthEaterParticle(const CEffect_Custom_EarthEaterParticle& rhs);
	virtual ~CEffect_Custom_EarthEaterParticle() = default;
...
public:
	static CEffect_Custom_EarthEaterParticle* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
