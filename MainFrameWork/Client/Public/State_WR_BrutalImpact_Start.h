...
class CState_WR_BrutalImpact_Start final : public CState_Skill
{
public:
	CState_WR_BrutalImpact_Start(const wstring& strStateName, class CStateMachine* pMachine, class CPlayer_Controller* pController, class CPlayer_Slayer* pOwner);
	virtual ~CState_WR_BrutalImpact_Start() = default;
