...
namespace Client
{
	...
	enum OBJ_TYPE { PLAYER, MONSTER, BOSS, NPC, SKILL, TERRAIN, PROP, UI, COLMESH, EFFECT, SPAWNER, PART, PROJECTILE, DUNGEAN, OBJ_END };
...
#define SERVER_IP		L"127.0.0.1"//L"192.168.0.30"
