...
class CState_GN_FreeShooter final : public CState_Skill
{
public:
	CState_GN_FreeShooter(const wstring& strStateName, class CStateMachine* pMachine, class CPlayer_Controller* pController, class CPlayer_Gunslinger* pOwner);
	virtual ~CState_GN_FreeShooter() = default;
