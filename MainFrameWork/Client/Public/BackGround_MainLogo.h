...
class CBackGround_MainLogo final : public CGameObject
{
protected:
	/* 원형을 생성할 때 */
	CBackGround_MainLogo(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	/* 사본을 생성할 때 */
	CBackGround_MainLogo(const CGameObject& rhs); /* 복사 생성자. */

	virtual ~CBackGround_MainLogo() = default;
