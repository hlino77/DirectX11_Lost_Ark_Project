...
{
private:
	CLevel_ValtanMain(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	virtual ~CLevel_ValtanMain() = default;
...
public:
	static class CLevel_ValtanMain* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
