...
{
public:
	CState_WR_WildRush_End(const wstring& strStateName, class CStateMachine* pMachine, class CPlayer_Controller* pController, class CPlayer_Slayer* pOwner);
	virtual ~CState_WR_WildRush_End() = default;
...
private:
	void	Effect_WildRush_End();

private:
	class CPlayer_Slayer* m_pPlayer = nullptr;

	std::function<void(CState_WR_WildRush_End&, _float)> m_TickFunc;
