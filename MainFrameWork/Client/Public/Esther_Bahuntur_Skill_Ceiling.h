...
class CEsther_Bahuntur_Skill_Ceiling final : public CGameObject
{
private:
	CEsther_Bahuntur_Skill_Ceiling(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CEsther_Bahuntur_Skill_Ceiling(const CEsther_Bahuntur_Skill_Ceiling& rhs);
	virtual ~CEsther_Bahuntur_Skill_Ceiling() = default;
...
public:
	static CEsther_Bahuntur_Skill_Ceiling* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, void* pArg);
