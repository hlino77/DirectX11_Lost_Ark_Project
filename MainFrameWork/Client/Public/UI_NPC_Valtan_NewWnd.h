...
class CUI_NPC_ValtanEntrance_Wnd :
    public CUI
{
private:
    CUI_NPC_ValtanEntrance_Wnd(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
    CUI_NPC_ValtanEntrance_Wnd(const CUI& rhs);
    virtual ~CUI_NPC_ValtanEntrance_Wnd() = default;
