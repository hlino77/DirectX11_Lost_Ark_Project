...
HRESULT CState_WR_Hit::Initialize()
{
	...
	m_SoundFrames.push_back(SOUNDDESC(0, TEXT("Effect"), TEXT("WR_Hit_381.wav")));
...
void CState_WR_Hit::Enter_State()
{
	...
	{
		m_SoundFrames.front().strName = TEXT("WR_Hit_381.wav");
	}
	else
	{
		m_SoundFrames.front().strName = TEXT("WR_Hit_389.wav");
	}
