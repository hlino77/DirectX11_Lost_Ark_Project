...
void CUI_PartyUI::Print_Text()
{
	...
	Vec2 vMeasure = CGameInstance::GetInstance()->MeasureString(L"³Ø½¼Lv1°íµñBold", TEXT("¸ðÄÚÄÚÆÄÆ¼"));
	Vec2 vOrigin = vMeasure * 0.5f;
	m_pTextBox->Set_Text(m_strWndTag, m_strFont, TEXT("¸ðÄÚÄÚÆÄÆ¼"), Vec2(m_fSizeX * 0.2f , m_fSizeY * 0.5f), Vec2(0.4f, 0.4f), vOrigin, 0.f, Vec4(1.0f, 1.0f, 1.0f, 1.0f));
}
