...
HRESULT CUI_IdentityGN_WeaponFrame::Initialize(void* pArg)
{
	...
	m_strUITag = TEXT("IdentityGN_IconShine");
...
HRESULT CUI_IdentityGN_WeaponFrame::Ready_Components()
{
	...
	/* Com_Texture*/
	if (FAILED(__super::Add_Component(LEVEL_STATIC, TEXT("Prototype_Component_Texture_IdentityGN_WeaponFrame_BackShineEffect"),
