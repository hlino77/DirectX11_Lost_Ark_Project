...
CBT_Node::BT_RETURN CValtan_BT_Phase2::OnUpdate(_float fTimeDelta)
{
	...
	Add_Sound(0, 0, L"Effect", L"Valtan#113 (872104708)", 23);
	Add_Sound(0, 1, L"Effect", L"Valtan#153 (153317365)", 23);
				
	Add_Sound(2, 2, L"Effect", L"Valtan#154 (178464551)",  9);
	Add_Sound(2, 3, L"Effect", L"Valtan#392 (75108078)",  9);
	Add_Sound(2, 6, L"Effect", L"Valtan#43 (1015057785)",  9);
				
	Add_Sound(3, 4, L"Effect", L"Valtan#50 (428724023)",  41);
	Add_Sound(3, 5, L"Effect", L"Valtan#237 (128183717)",  65);
