...
CBT_Node::BT_RETURN CValtan_BT_Attack_FrontBackWave::OnUpdate(_float fTimeDelta)
{
	...
	{
		m_bShoot[1] = false;
		Add_Sound(L"Effect", L"Valtan#65 (7989749)");
		CServerSessionManager::GetInstance()->Get_Player()->Get_Camera()->Cam_Shake(0.1f, 90.0f, 0.1f, 11.0f);
		CSkill::ModelDesc ModelDesc = {};
		ModelDesc.iLayer = (_uint)LAYER_TYPE::LAYER_SKILL;
		ModelDesc.iObjectID = -1;
	...
	{
		m_bShoot[2] = false;
		Add_Sound(L"Effect", L"Valtan#104 (160150074)");
		CServerSessionManager::GetInstance()->Get_Player()->Get_Camera()->Cam_Shake(0.1f, 90.0f, 0.1f, 11.0f);
		CSkill::ModelDesc ModelDesc = {};
		ModelDesc.iLayer = (_uint)LAYER_TYPE::LAYER_SKILL;
		ModelDesc.iObjectID = -1;
	...
	{
		Add_Sound(0, 0, L"Effect", L"Valtan#17 (437813884)",23);
		Add_Sound(0, 1, L"Effect", L"Valtan#44 (813796387)",60);
		Add_Sound(2, 2, L"Effect", L"Valtan#91 (483284436)",23);
	}
