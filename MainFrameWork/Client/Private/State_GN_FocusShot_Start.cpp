...
HRESULT CState_GN_FocusShot_Start::Initialize()
{
	...
	m_SoundFrames.push_back(SOUNDDESC(0, TEXT("Effect"), TEXT("GN_UmUp_639.wav")));
	m_SoundFrames.push_back(SOUNDDESC(5, TEXT("Effect"), TEXT("GN_Focus_110.wav")));
	m_SoundFrames.push_back(SOUNDDESC(20, TEXT("Effect"), TEXT("GN_Focus_111.wav")));
