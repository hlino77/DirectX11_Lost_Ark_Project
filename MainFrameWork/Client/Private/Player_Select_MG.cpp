...
CPlayer_Select_MG::CPlayer_Select_MG(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	:CPlayer_Select(pDevice, pContext)
{
}

CPlayer_Select_MG::CPlayer_Select_MG(const CPlayer_Select_MG& rhs)
	: CPlayer_Select(rhs)
{
}

HRESULT CPlayer_Select_MG::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CPlayer_Select_MG::Initialize(void* pArg)
{
	m_strObjectTag = TEXT("MG");
	...
	m_vSelectPos = Vec3(1.05f, 0.04f, 0.927f);
...
void CPlayer_Select_MG::Tick(_float fTimeDelta)
{
...
void CPlayer_Select_MG::LateTick(_float fTimeDelta)
{
...
HRESULT CPlayer_Select_MG::Render()
{
	__super::Render();
...
HRESULT CPlayer_Select_MG::Render_ShadowDepth()
{
...
void CPlayer_Select_MG::Set_Colliders(_float fTimeDelta)
{
...
HRESULT CPlayer_Select_MG::Ready_Components()
{
...
HRESULT CPlayer_Select_MG::Ready_Coliders()
{
	{
...
HRESULT CPlayer_Select_MG::Ready_Part()
{
	CGameInstance* pGameInstance = GET_INSTANCE(CGameInstance);
...
CPlayer_Select_MG* CPlayer_Select_MG::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CPlayer_Select_MG* pInstance = new CPlayer_Select_MG(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed To Created : CPlayer_Select_MG");
...
CGameObject* CPlayer_Select_MG::Clone(void* pArg)
{
	CPlayer_Select_MG* pInstance = new CPlayer_Select_MG(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed To Cloned : CPlayer_Select_MG");
		Safe_Release(pInstance);
	}
