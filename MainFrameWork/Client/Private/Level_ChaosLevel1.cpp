...
HRESULT CLevel_ChaosLevel1::Ready_Layer_BackGround(const LAYER_TYPE eLayerType)
{
	...
	//Load_MapData(LEVELID::eLevel, L"../Bin/Resources/MapData/Arena.data");
	...
	for (_uint i = 0; i < 1; ++i)
	{
		CGameObject* pObject = pGameInstance->Add_GameObject(LEVEL_CHAOS_1, Desc.iLayer, TEXT("Prototype_GameObject_StaticModel"), &Desc);
		if (nullptr == pObject)
		{
			Safe_Release(pGameInstance);
			return E_FAIL;
...
void CLevel_ChaosLevel1::Send_LevelState(LEVELSTATE eState)
{
