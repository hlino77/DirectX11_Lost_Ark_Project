...
{
	m_iSpiningSword_Start = m_pPlayer->Get_ModelCom()->Initailize_FindAnimation(L"sk_windblade_01", 1.1f);
	...
	m_SoundFrames.push_back(SOUNDDESC(0, TEXT("Effect"), TEXT("WR_Tahat_354.wav")));
...
{
	_uint iAnimFrame = m_pPlayer->Get_ModelCom()->Get_Anim_Frame(m_iSpiningSword_Start);
