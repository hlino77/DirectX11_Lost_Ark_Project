...
CEffect_Custom_EarthEaterSmallParticle::CEffect_Custom_EarthEaterSmallParticle(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: Super(pDevice, pContext)
{
}

CEffect_Custom_EarthEaterSmallParticle::CEffect_Custom_EarthEaterSmallParticle(const CEffect_Custom_EarthEaterSmallParticle& rhs)
	: Super(rhs)
{
}

HRESULT CEffect_Custom_EarthEaterSmallParticle::Initialize_Prototype(EFFECTDESC* pDesc)
{
	return S_OK;
}

HRESULT CEffect_Custom_EarthEaterSmallParticle::Initialize(void* pArg)
{
...
void CEffect_Custom_EarthEaterSmallParticle::LateTick(_float fTimeDelta)
{
	if (m_bRender)
	{
...
HRESULT CEffect_Custom_EarthEaterSmallParticle::Render()
{
...
void CEffect_Custom_EarthEaterSmallParticle::Reset(CustomEffectDesc& tDesc)
{
	m_SwingPos.clear();
	m_TurnPos.clear();
...
void CEffect_Custom_EarthEaterSmallParticle::Tick_Start(_float fTimeDelta)
{
...
void CEffect_Custom_EarthEaterSmallParticle::Tick_Turn(_float fTimeDelta)
{
	Update_Rotation(fTimeDelta);
...
void CEffect_Custom_EarthEaterSmallParticle::Tick_Swing(_float fTimeDelta)
{
	Update_Rotation(fTimeDelta);
...
void CEffect_Custom_EarthEaterSmallParticle::Tick_Shot(_float fTimeDelta)
{
	Update_Rotation(fTimeDelta);
...
void CEffect_Custom_EarthEaterSmallParticle::Tick_Disappear(_float fTimeDelta)
{
	if (m_fTimeAcc >= m_fLifeTime)
	{
		...
		{
			Set_Active(false);
			CPool<CEffect_Custom_EarthEaterSmallParticle>::Return_Obj(this);
		}
	}
	else
	{
...
void CEffect_Custom_EarthEaterSmallParticle::Set_Swing()
{
...
void CEffect_Custom_EarthEaterSmallParticle::Effect_Exit()
{
	Set_Active(false);
	CPool<CEffect_Custom_EarthEaterSmallParticle>::Return_Obj(this);
}

void CEffect_Custom_EarthEaterSmallParticle::Update_Rotation(_float fTimeDelta)
{
...
void CEffect_Custom_EarthEaterSmallParticle::Init_TurnPos()
{
	CGameInstance* pGameInstance = GET_INSTANCE(CGameInstance);
...
void CEffect_Custom_EarthEaterSmallParticle::Init_SwingPos()
{
	CGameInstance* pGameInstance = GET_INSTANCE(CGameInstance);
...
void CEffect_Custom_EarthEaterSmallParticle::Init_Shot()
{
	CGameInstance* pGameInstance = GET_INSTANCE(CGameInstance);
...
void CEffect_Custom_EarthEaterSmallParticle::Update_RockPos(_float fTimedelta)
{
	m_fTimeAcc += fTimedelta;
...
HRESULT CEffect_Custom_EarthEaterSmallParticle::Ready_Components()
{
	...
	strModelName += to_wstring(rand() % 3 + 3);
...
CEffect_Custom_EarthEaterSmallParticle* CEffect_Custom_EarthEaterSmallParticle::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CEffect_Custom_EarthEaterSmallParticle* pInstance = new CEffect_Custom_EarthEaterSmallParticle(pDevice, pContext);
...
CGameObject* CEffect_Custom_EarthEaterSmallParticle::Clone(void* pArg)
{
	CEffect_Custom_EarthEaterSmallParticle* pInstance = new CEffect_Custom_EarthEaterSmallParticle(*this);
...
void CEffect_Custom_EarthEaterSmallParticle::Free()
{
	Super::Free();
}
