...
CUI_NPC_ValtanEntrance_Wnd::CUI_NPC_ValtanEntrance_Wnd(const CUI& rhs)
    : CUI(rhs)
{
}

HRESULT CUI_NPC_ValtanEntrance_Wnd::Initialize_Prototype()
{
    return S_OK;
}

HRESULT CUI_NPC_ValtanEntrance_Wnd::Initialize(void* pArg)
{
...
HRESULT CUI_NPC_ValtanEntrance_Wnd::Initialize_TextBox()
{
    m_strText = TEXT("¹ßÅº ·¹ÀÌµå¿¡ ÀÔÀåÇÏ½Ã°Ú½À´Ï±î?");
    m_strTimeCount = TEXT("10ÃÊ ³²¾Ò½À´Ï´Ù.");
    Ready_TextBox();
    Set_Active(false);
...
void CUI_NPC_ValtanEntrance_Wnd::Tick(_float fTimeDelta)
{
    if (true == m_bDeActive)
    {
...
void CUI_NPC_ValtanEntrance_Wnd::LateTick(_float fTimeDelta)
{
...
HRESULT CUI_NPC_ValtanEntrance_Wnd::Render()
{
...
void CUI_NPC_ValtanEntrance_Wnd::Start_Text()
{
...
void CUI_NPC_ValtanEntrance_Wnd::End_Text()
{
    m_strTimeCount.clear();
    m_strText.clear();
    m_pTextBoxWnd->Set_Active(false);
...
void CUI_NPC_ValtanEntrance_Wnd::Print_Text()
{
    if (nullptr != m_pTextBoxWnd)
    {
        ...
        m_pTextBoxWnd->Set_Text(m_strTag, TEXT("³Ø½¼Lv1°íµñBold"), m_strText, Vec2(243.5f, 72.f), Vec2(0.4f, 0.4f), vOrigin, 0.f, Vec4(1.0f, 1.0f, 1.0f, 1.f));
    }
    ...
    if (nullptr != m_pTimeCountWnd)
    {
        ...
        m_strTimeCount = to_wstring((_uint)m_fCurrTimer) + TEXT("ÃÊ") + TEXT(" ³²¾Ò½À´Ï´Ù.");
        Vec2 vMeasure = CGameInstance::GetInstance()->MeasureString(TEXT("³Ø½¼Lv1°íµñBold"), m_strTimeCount);
        Vec2 vOrigin = vMeasure * 0.5f;
        m_pTimeCountWnd->Set_Text(m_strTag_Timer, TEXT("³Ø½¼Lv1°íµñBold"), m_strTimeCount, Vec2(243.5f, 140.f), Vec2(0.4f, 0.4f), vOrigin, 0.f, Vec4(1.0f, 1.0f, 1.0f, 1.f));
    }
}

void CUI_NPC_ValtanEntrance_Wnd::Set_Player_Control()
{
...
void CUI_NPC_ValtanEntrance_Wnd::Set_Active(_bool bActive)
{
    if(false == bActive)
...
_bool CUI_NPC_ValtanEntrance_Wnd::Is_Entered()
{
    return m_bClicked_Entrance; 
}

HRESULT CUI_NPC_ValtanEntrance_Wnd::Ready_TextBox()
{
    ...
    if (nullptr == m_pTextBoxWnd)
    {
        ...
        tTextDesc.szTextBoxTag = TEXT("ValtanRaid_Entrance_NewWnd");
    ...
    {
        CTextBox::TEXTBOXDESC tTextDesc;
        tTextDesc.szTextBoxTag = TEXT("ValtanRaid_Entrance_TimeCounter");
...
void CUI_NPC_ValtanEntrance_Wnd::Update_MovingWnd(POINT pt)
{
...
void CUI_NPC_ValtanEntrance_Wnd::Update_Button()
{
    POINT pt;
    GetCursorPos(&pt);
...
void CUI_NPC_ValtanEntrance_Wnd::Update_AcceptButton(POINT pt)
{
...
void CUI_NPC_ValtanEntrance_Wnd::Create_Rect_RefuseButton()
{
...
_bool CUI_NPC_ValtanEntrance_Wnd::Is_Picking_AcceptButton(POINT pt)
{
...
_bool CUI_NPC_ValtanEntrance_Wnd::Is_Picking_RefuseButton(POINT pt)
{
...
void CUI_NPC_ValtanEntrance_Wnd::Create_Rect_MovingWnd()
{
...
_bool CUI_NPC_ValtanEntrance_Wnd::Is_Picking_MovingWnd(POINT pt)
{
...
void CUI_NPC_ValtanEntrance_Wnd::Reset_Player_Control()
{
    CPlayer* pPlayer = CServerSessionManager::GetInstance()->Get_Player();
    if (nullptr == pPlayer)
        return;
...
HRESULT CUI_NPC_ValtanEntrance_Wnd::Ready_Components()
{
    __super::Ready_Components();

    /* Com_Texture*/
    if (FAILED(__super::Add_Component(LEVEL_STATIC, TEXT("Prototype_Component_Texture_Npc_Valtan_Entrance_Wnd"),
...
HRESULT CUI_NPC_ValtanEntrance_Wnd::Bind_ShaderResources()
{
...
HRESULT CUI_NPC_ValtanEntrance_Wnd::Bind_ShaderResources_AcceptButton()
{
...
HRESULT CUI_NPC_ValtanEntrance_Wnd::Bind_ShaderResources_RefuseButton()
{
...
HRESULT CUI_NPC_ValtanEntrance_Wnd::Bind_ShaderResources_Timer()
{
...
CUI_NPC_ValtanEntrance_Wnd* CUI_NPC_ValtanEntrance_Wnd::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
    CUI_NPC_ValtanEntrance_Wnd* pInstance = new CUI_NPC_ValtanEntrance_Wnd(pDevice, pContext);

    if (FAILED(pInstance->Initialize_Prototype()))
    {
        MSG_BOX("Failed to Created : CUI_NPC_ValtanEntrance_Wnd");
...
CGameObject* CUI_NPC_ValtanEntrance_Wnd::Clone(void* pArg)
{
    CUI_NPC_ValtanEntrance_Wnd* pInstance = new CUI_NPC_ValtanEntrance_Wnd(*this);

    if (FAILED(pInstance->Initialize(pArg)))
    {
        MSG_BOX("Failed to Cloned : CUI_NPC_ValtanEntrance_Wnd");
        Safe_Release(pInstance);
    }
...
void CUI_NPC_ValtanEntrance_Wnd::Free()
{
    __super::Free();
