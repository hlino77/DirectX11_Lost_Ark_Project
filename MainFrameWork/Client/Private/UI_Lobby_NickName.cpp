...
void CUI_Lobby_NickName::Random_NickName()
{
	...
	{
	case 0 :
		m_strNickName = TEXT("Áê½Å6232±â");
		break;
	case 1:
		m_strNickName = TEXT("·Î¾ÆÇÏ°í½Í¾î¿ä");
		break;
	case 2:
		m_strNickName = TEXT("³»³ú°¡Nullptr");
		break;
	case 3:
		m_strNickName = TEXT("ÀÌ°Å¿Ö¾ÈµÅ");
		break;
	case 4:
		m_strNickName = TEXT("¿ÖÅÍÁöÁö");
		break;
	case 5:
		m_strNickName = TEXT("µµ¿ÍÁàGpt");
		break;
	case 6:
		m_strNickName = TEXT("ÇÒ°Ô³Ê¹«¸¹¾Æ");
		break;
	case 7:
		m_strNickName = TEXT("·Î¾Æ°¡¶â±â³×");
		break;
	case 8:
		m_strNickName = TEXT("Ã¥ÀÓÀÚ´ÂÆÀÀå");
		break;
	case 9:
		m_strNickName = TEXT("³»Àß¸ø¾Æ´Ô");
		break;
	case 10:
		m_strNickName = TEXT("»ì·ÁÁÖ¼¼¿ä");
		break;
	}*/
	if ((_uint)CHR_CLASS::GUNSLINGER == m_iClassIndex)
		m_strNickName = TEXT("A±ÞÇÑ¿ì");
	else if((_uint)CHR_CLASS::SLAYER ==  m_iClassIndex)
		m_strNickName = TEXT("Áê½ÅÅä³¢°Ïµà");
	else if ((_uint)CHR_CLASS::DESTROYER == m_iClassIndex)
		m_strNickName = TEXT("µðºØÀÌ");
	else if ((_uint)CHR_CLASS::DOAGA == m_iClassIndex)
		m_strNickName = TEXT("ÇÑº×ÇÈÇÏ¼Ò");
}
