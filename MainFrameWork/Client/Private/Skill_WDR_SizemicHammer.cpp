...
HRESULT CSkill_WDR_SizemicHammer::Initialize(void* pArg)
{
	...
	Proj_Desc.vChildScale = Vec3(2.f, 0.6f, 1.2f);
	Proj_Desc.vChildOffset = Vec3(0.0f, 0.6f, 0.2f);
	...
	Proj_Desc.eLayer_Collider = (_uint)LAYER_COLLIDER::LAYER_SKILL_PLAYER;
	Proj_Desc.fAttackTime = 0.1f;
	Proj_Desc.fRadius = 8.f;
	Proj_Desc.vOffset = Vec3(0.0f, 0.2f, 6.2f);
	Proj_Desc.vChildScale = Vec3(8.f, 0.6f, 6.f);
	Proj_Desc.vChildOffset = Vec3(0.0f, 0.6f, 6.2f);
