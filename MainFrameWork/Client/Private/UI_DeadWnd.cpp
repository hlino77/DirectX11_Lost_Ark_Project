...
void CUI_DeadWnd::Print_TextBoxWatching()
{
	...
	Vec2 vMeasure = CGameInstance::GetInstance()->MeasureString(m_strFont, TEXT("관전하기"));
	Vec2 vOrigin = vMeasure * 0.5f;
	m_pTextBox_Watching->Set_Text(m_strWatchingTag, m_strFont, TEXT("관전하기"), Vec2((101.f * 1.8f * 0.5f), (34.f * 1.5f - 48.f * 0.5f)), Vec2(0.4f, 0.4f), vOrigin, 0.f, Vec4(1.f, 1.f, 1.f, 1.0f));
}
