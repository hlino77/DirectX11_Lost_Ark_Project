...
CSKill_Valtan_DoughnutFirstHit::CSKill_Valtan_DoughnutFirstHit(const CSKill_Valtan_DoughnutFirstHit& rhs)
          : CSkill(rhs)
{
}

HRESULT CSKill_Valtan_DoughnutFirstHit::Initialize_Prototype()
{
...
HRESULT CSKill_Valtan_DoughnutFirstHit::Initialize(void* pArg)
{
...
void CSKill_Valtan_DoughnutFirstHit::Tick(_float fTimeDelta)
{
...
void CSKill_Valtan_DoughnutFirstHit::LateTick(_float fTimeDelta)
{
    __super::LateTick(fTimeDelta);
}

HRESULT CSKill_Valtan_DoughnutFirstHit::Render()
{
...
void CSKill_Valtan_DoughnutFirstHit::OnCollisionEnter(const _uint iColLayer, CCollider* pOther)
{
}

void CSKill_Valtan_DoughnutFirstHit::OnCollisionStay(const _uint iColLayer, CCollider* pOther)
{
}

void CSKill_Valtan_DoughnutFirstHit::OnCollisionExit(const _uint iColLayer, CCollider* pOther)
{
}


HRESULT CSKill_Valtan_DoughnutFirstHit::Ready_Coliders()
{
	{
...
void CSKill_Valtan_DoughnutFirstHit::Set_DoughnutRadii(_float OutsideRadius, _float InsideRadius)
{
...
HRESULT CSKill_Valtan_DoughnutFirstHit::Ready_Components()
{
...
CSKill_Valtan_DoughnutFirstHit* CSKill_Valtan_DoughnutFirstHit::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
    CSKill_Valtan_DoughnutFirstHit* pInstance = new CSKill_Valtan_DoughnutFirstHit(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed To Created : CSKill_Valtan_DoughnutFirstHit");
...
CGameObject* CSKill_Valtan_DoughnutFirstHit::Clone(void* pArg)
{
    CSKill_Valtan_DoughnutFirstHit* pInstance = new CSKill_Valtan_DoughnutFirstHit(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed To Cloned : CSKill_Valtan_DoughnutFirstHit");
		Safe_Release(pInstance);
	}
...
void CSKill_Valtan_DoughnutFirstHit::Free()
{
	__super::Free();
}
