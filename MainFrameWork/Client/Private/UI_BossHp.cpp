...
HRESULT CUI_Boss_Hp::Initialize_StageName(const wstring& strName)
{
...
void CUI_Boss_Hp::Start_InGame_Name()
{
	m_strName.clear();
	m_pInGameNameWnd->Set_Active(true);
}

void CUI_Boss_Hp::End_InGame_Name()
{
	m_strName.clear();
	m_pInGameNameWnd->Set_Active(false);
}

void CUI_Boss_Hp::Update_NamePlatePos()
{
	if (nullptr != m_pOwner)
	{
...
void CUI_Boss_Hp::Print_InGame_Name()
{
