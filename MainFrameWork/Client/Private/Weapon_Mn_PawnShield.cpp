...
CWeapon_Mn_PawnShield::CWeapon_Mn_PawnShield(const CWeapon_Mn_PawnShield& rhs)
	: CPartObject(rhs)
{

}

HRESULT CWeapon_Mn_PawnShield::Initialize_Prototype()
{
...
HRESULT CWeapon_Mn_PawnShield::Initialize(void* pArg)
{
...
void CWeapon_Mn_PawnShield::Tick(_float fTimeDelta)
{
...
void CWeapon_Mn_PawnShield::LateTick(_float fTimeDelta)
{
...
HRESULT CWeapon_Mn_PawnShield::Render()
{
...
HRESULT CWeapon_Mn_PawnShield::Render_ShadowDepth()
{
...
HRESULT CWeapon_Mn_PawnShield::Ready_Components()
{
	/* For.Com_Transform */
	...
	///* For.Com_Model */
	wstring strComName = L"Prototype_Component_Model_Weapon_Mn_PawnShield";
...
HRESULT CWeapon_Mn_PawnShield::Bind_ShaderResources()
{
...
CWeapon_Mn_PawnShield* CWeapon_Mn_PawnShield::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CWeapon_Mn_PawnShield* pInstance = new CWeapon_Mn_PawnShield(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Created : CWeapon_Mn_PawnShield");
...
CGameObject* CWeapon_Mn_PawnShield::Clone(void* pArg)
{
	__super::Clone(pArg);

	CWeapon_Mn_PawnShield* pInstance = new CWeapon_Mn_PawnShield(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Cloned : CWeapon_Mn_PawnShield");
		Safe_Release(pInstance);
	}
...
void CWeapon_Mn_PawnShield::Free()
{
	__super::Free();
