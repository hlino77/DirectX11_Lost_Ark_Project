...
CSkill_GN_TargetDown::CSkill_GN_TargetDown(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, CPlayer_Gunslinger* pPlayer)
	: CPlayer_Skill(pDevice, pContext, TEXT("SKill_GN_TargetDown"), OBJ_TYPE::SKILL), m_pPlayer(pPlayer)
{
}
...
HRESULT CSkill_GN_TargetDown::Ready_Components()
{
	...
	if (FAILED(__super::Add_Component(LEVEL_STATIC, TEXT("Prototype_Component_Texture_Skill_Target_Down"),
